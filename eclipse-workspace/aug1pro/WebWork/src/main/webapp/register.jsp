...
<body  style="background-image: radial-gradient(circle, #093204, #335104, #677000, #a48d00, #eba512);background-repeat:no-repeat; background-attachment:fixed; background-size:cover;">
